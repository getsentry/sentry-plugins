...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('jira_ac_tenant', (
            ('id', self.gf('sentry.db.models.fields.bounded.BoundedBigAutoField')(primary_key=True)),
            ('organization', self.gf('sentry.db.models.fields.foreignkey.FlexibleForeignKey')(blank=True, related_name='jira_tenant_set', null=True, to=orm['sentry.Organization'])),
    ...
    models = {
        'jira_ac.jiratenant': {
            ...
            'organization': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'blank': 'True', 'related_name': "'jira_tenant_set'", 'null': 'True', 'to': "orm['sentry.Organization']"}),
